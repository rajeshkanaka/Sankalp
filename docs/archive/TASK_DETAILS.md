# Historical task details — superseded by D21 where scope differs

Not a task-status authority. Current rows and requirements: [TASKS](../TASKS.md).
