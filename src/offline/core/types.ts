...
export type Resolution =
  | { kind: 'use_server'; expectedOperationIds: Id[]; expectedDraftRevision: number }
  | {
...
export interface ReplayTransport {
  ...
  current(scope: AccountScope, operation: QueueOperation, signal: AbortSignal): Promise<Conflict>;
}
